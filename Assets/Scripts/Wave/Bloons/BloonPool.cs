...
namespace ServiceLocator.Wave.Bloon
{
    public class BloonPool : GenericObjectPool<BloonController>
    {
        ...
        public BloonPool(WaveService waveService, SoundService soundService, PlayerService playerService, WaveScriptableObject waveScriptableObject)
        {
        ...
        protected override BloonController CreateItem() => new BloonController(waveService, soundService, playerService, bloonPrefab, bloonContainer);
    }
}